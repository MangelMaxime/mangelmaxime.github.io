...
let mainPage (ctx: Context) (pageContent: ReactElement) =
    let titleText =
...
<a href="https://twitter.com/5t3ph/" class="button" aria-label="Twitter">
    <svg aria-hidden="true" focusable="false" width="24" height="24" fill="currentColor" class="button__icon">
...
<svg aria-hidden="true" focusable="false" hidden="true" style="display:none;">
    <defs>
...
let generationErrorPage (ctx: Context) =
    div [
        h1 "Error"
