...
module Sass =
    ...
    let private createCompilerProcess
        ...
        psi.WorkingDirectory <- ProjectRoot.toString projectRoot
    ...
    let compile (projectRoot: ProjectRoot.T) (sassArgs: SassArg list) =
    ...
    let watch (projectRoot: ProjectRoot.T) (sassArgs: SassArg list) =
