...
const PreviousPageButton = ({
    ...
    const previousButtonHref =
        previousPageContext.data.metadata.baseUrl + previousPageId + ".html";
...
const NextPageButton = ({
    ...
    const nextButtonHref =
        nextPageContext.data.metadata.baseUrl + nextPageId + ".html";
...
function navigationFilter(this: any, pages: any[]) {
    ...
    if (!currentPage.data.menu) {
        return null;
    }

    const flatMenu = flattenMenu(currentPage.data.menu);
